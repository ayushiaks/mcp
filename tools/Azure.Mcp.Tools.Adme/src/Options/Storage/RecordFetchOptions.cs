...
public sealed class RecordFetchOptions
{
    ...
    [Option(Description = "Dotted-path fields to return instead of whole records, for example 'data.Name' and 'data.FileSourceInfo'. It cannot be combined with --frame-of-reference.")]
    public string[]? Attributes { get; set; }

    [Option(Description = "Convert measurements to SI, coordinates to WGS84 and dates to UTC on the server.")]
