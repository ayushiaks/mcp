...
public sealed class RecordGetOptions
{
    ...
    [Option(Description = "The numeric record version to retrieve. Omit to get the latest version; use 'azmcp adme storage record version list' to discover valid versions. It cannot be combined with --attributes.")]
    public long? Version { get; set; }

    [Option(Description = "Dotted-path fields to return from the latest record instead of the whole record, for example 'data.WellID' and 'data.Name'. It cannot be combined with --version.")]
